...
function Impact() {
  return (
    <div className="Impact">
       <div className="Title">
         <h2>Our Progress</h2>
    <h3> Stones Of Light Education Foundation has been facilitating the education of impoverished children and bringing educators together <b>in Guatemala since April of 2011</b>. As a result, the quality of life is improving for countless people in Guatemala.</h3>
       </div>
